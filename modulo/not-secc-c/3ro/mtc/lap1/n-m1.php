                  ...
                  <thead>
                   ...
                   <tbody>
                    <?php // visualizar estudiantes
                             ...
                             $sql = "SELECT * FROM alumno  WHERE id_grado=3 AND id_seccion=3 ORDER by cedula";
                     ...
                     <tr>
                      ...
                      <input type="hidden" required name="materia[]" value="5" class="form-control input-sm">
                      <input type="hidden" required name="lapso[]" value="1" class="form-control input-sm"> 
