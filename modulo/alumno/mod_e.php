           ...
           <div class="title_left">
            ...
            <div class="title_right"> 
                  ...
                  <div class="container">
                    <div class="row">   
                         <div class="col-md-7">
                      <!-- <button class="btn btn-primary  active" onclick="document.getElementById('modal-wrapper').style.display='block'" > Agregar Nuevo Estudiante</button> -->
                          <a class="btn btn-primary  active" href="../reg-est/re-1.php">REGISTRAR NUEVO ESTUDIANTE</a>
                         </div>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    <?php // visualizar estudiantes
                            ...
                            $sql = "SELECT id_alumno, nombre, apellido, cedula, sexo, edad, grado, seccion 
                                      FROM alumno INNER JOIN grado  ON alumno.id_grado=grado.id_grado 
                                     INNER JOIN seccion  ON alumno.id_seccion=seccion.id_seccion WHERE 1 ORDER BY grado";
