                  ...
                  <thead>
                   ...
                   <tbody>
                    <?php // visualizar estudiantes
                             ...
                             $sql = "SELECT * FROM alumno  WHERE id_grado=2 AND id_seccion=2 ORDER by cedula";
                     ...
                     <tr>
                      ...
                      <input type="hidden" required name="materia[]" value="8" class="form-control input-sm">
