...
$action='ajax';
	if($action == 'ajax'){
         $q = mysqli_real_escape_string($conDB,(strip_tags($_REQUEST['q'], ENT_QUOTES)));
		  $sTable = "alumno";
		 $sWhere = "";
		...
		$count_query   = mysqli_query($conDB, "SELECT co
			unt(*) AS numrows FROM $sTable  $sWhere");
			  ...
			  <table class="table table-hover" style="border-color: #337ab7;">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td><?php echo utf8_encode($cedula); ?></td>	
